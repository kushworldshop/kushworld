          ...
          {EMOTES.slice(0, 6).map((emote) => {
            ...
            return (
              <button
                ...
                title={emote.label}
              >
                <span className="inline-flex items-center justify-center w-3.5 h-3.5 text-[8px] leading-none font-bold bg-[#00ff9d] text-black rounded-full">{emote.label.split(' ').map(w => w[0]).join('')}</span>
